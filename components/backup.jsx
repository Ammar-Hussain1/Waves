...
function CheckOut() {
  ...
  defaultValue="US" // Use defaultValue here
  ...
  <option value="UK">United Kingdom</option>
              ...
              <div>
                ...
                <select
                    ...
                    defaultValue="SF" // use a value that matches the default option
                    className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                    >
          ...
          <div className="flex items-start">
            <div className="flex h-5 items-center">
              <input
                ...
                name="payment-method"
                value="credit-card"
                checked={paymentMethod === 'credit-card'} // Set based on selected method
                onChange={handlePaymentChange} // Update the state on change
          ...
          <div className="flex items-start">
            <div className="flex h-5 items-center">
              <input
                ...
                checked={paymentMethod === 'pay-on-delivery'} // Set based on selected method
                onChange={handlePaymentChange} // Update the state on change
                className="h-4 w-4 border-gray-300 bg-white text-primary-600 focus:ring-2 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
              />
            </div>
          ...
          <div className="flex items-start">
            <div className="flex h-5 items-center">
              <input
                ...
                name="payment-method"
                value="paypal"
                checked={paymentMethod === 'paypal'} // Set based on selected method
                onChange={handlePaymentChange} // Update the state on change
                className="h-4 w-4 border-gray-300 bg-white text-primary-600 focus:ring-2 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
              />
            </div>
